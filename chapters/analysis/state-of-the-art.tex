...
In the time of writing, client is composed from six subapplications, namely: \texttt{KMEditor}, \texttt{KnowledgeModels}, \texttt{Organization}, \texttt{Public}, \texttt{Questionnaires} and \texttt{Users}.
